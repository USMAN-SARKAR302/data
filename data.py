...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : 🔥USMAN SARKAR🔥
 \033[1;93m(*)\033[1;92m Tool Type : SIM & CNIC DETAILS \033[1;93m(Only For Pak)
 \033[1;93m(*)\033[1;92m YouTube   : USMAN-TECH
 \033[1;93m(*)\033[1;92m Github    : USMAN-SARKAR302
\033[1;93m______________________________________________________"""
...
def main():
       ...
       # os.system('xdg-open https://youtube.com/@TAJAMMALMODSS?si=Sygcgpa3A9PVi2U100')
        print("")
        ...
        print("\x1b[1;93m[2] \x1b[1;92mDeveloper Facebook Account ")
        print("\x1b[1;93m[3] \x1b[1;92mjoin Our WhatsApp Group ")
        ...
        if SYED == '':
                ...
                os.system('xdg-open https://www.facebook.com/usmansarkargfubrandowner')
                main()
        elif SYED == '3':
                os.system('xdg-open https://https://chat.whatsapp.com/GrMaqHEYlbOJJZzc1h2VVU')
                main()
        elif SYED == '4':
                os.system('xdg-open https://youtube.com/@TAJAMMALMODSS?si=Sygcgpa3A9PVi2U10')
                main()
        elif SYED == '0':
                os.system('exit')
        else:
